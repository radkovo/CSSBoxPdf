...
public class Node {
     ...
     */    
    public Node getTreeEq() { return this.refToTreeEquivalent; }
    
    /**
     * Returns the parent ID
     */
    public int getParentIDOfNoninsertedNode() { return this.parentIDOfNoninsertedNode; }

    /**
     * Sets the variable parent ID
     */
    public void setParentIDOfNoninsertedNode(int parentID) { this.parentIDOfNoninsertedNode = parentID; }
    
    /**
     * Returns the reference to Parent Node of this Node
     */
    public Node getParentNode() { return this.nodeParent; }
    ...
    public Node insertNewNode(ElementBox elem, TextBox text, ReplacedBox box, Node refToTreeEquivalent) {
        ...
        if (elem != null)      { y = elem.getAbsoluteContentY(); }
        else if (text != null) { y = text.getAbsoluteContentY(); }
        else if (box != null)  { 
    ...
    public int getID() {
        ...
        if (this.elem != null)      { return elem.getOrder(); }
        else if (this.text != null) { return text.getOrder(); }
    ...
    public int getElemY() { 
        ...
        if (this.elem != null) { return elem.getAbsoluteContentY(); }
        else if (this.text != null) { return text.getAbsoluteContentY(); }
        else if (this.box != null) { 
            Rectangle cb = ((Box) box).getAbsoluteContentBounds();
            return cb.y; 
        }
    ...
    public int getElemX() { 
        ...
        if (this.elem != null) { return elem.getAbsoluteContentX(); }
        else if (this.text != null) { return text.getAbsoluteContentX(); }
        else if (this.box != null) { 
            Rectangle cb = ((Box) box).getAbsoluteContentBounds();
            return cb.x; 
        }
    ...
    public int getElemHeight() { 
        ...
        if (this.elem != null) { return elem.getHeight(); }
        else if (this.text != null) { return text.getHeight(); }
        else if (this.box != null) { 
            Rectangle cb = ((Box) box).getAbsoluteContentBounds();
            return cb.height; 
        }
    ...
    public int getElemWidth() { 
        ...
        if (this.elem != null) { return elem.getWidth(); }
        else if (this.text != null) { return text.getWidth(); }
        else if (this.box != null) { 
            Rectangle cb = ((Box) box).getAbsoluteContentBounds();
            return cb.width; 
        }
     ...
     */
    public boolean isElem() { if (this.elem != null) return true; else return false; }
    
    /**
     * Returns true if this object stores TEXT
     */
    public boolean isText() { if (this.text != null) return true; else return false; }
    
    /**
     * Returns true if this object stores BOX
     */
    public boolean isBox()  { if (this.box != null)  return true; else return false; }
    
    /**
     * Returns the ELEM stored in this object
     */
    public ElementBox getElem() { return this.elem; }
    
    /**
     * Returns the TEXT stored in this object
     */
    public TextBox getText()    { return this.text; }
    
    /**
     * Returns the BOX stored in this object
     */
    public ReplacedBox getBox() { return this.box; }
     ...
     */
    public void addPlusOffset(float newPlusOffset) { this.plusOffset += newPlusOffset; }
  
    /**
     * Returns the offset of this object
     */
    public float getPlusOffset() { return this.plusOffset; }    
    
    /**
     * Add an increment to height for this object
     */
    public void addPlusHeight(float newPlusHeight) { this.plusHeight += newPlusHeight; }
    
    /**
     * Returns the increment to height for this object
     */
    public float getPlusHeight() { return this.plusHeight; }
}

...
public class Filter {
    ...
    /**
	 * This function represents CSS3 filter function grayscale(). However, it is working only with grayscale
	 * parameter 100%
	 * @return the filtered image 
	 * @param img the original image to be filtered
	 */
    ...
    /**
	 * This function invokes other methods from this class depending on the filter name.
	 * @return the filtered image 
	 * @param img the original image to be filtered
	 */
